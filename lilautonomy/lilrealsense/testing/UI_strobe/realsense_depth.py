...
def main(in_queue, out_queue, testing):
    if testing:
        CMDS = {
        "roll":     1500,
        "pitch":    1500,
        ...
        try:
            ...
            while True:
                ...
                # Calls to get_frame_data(...) and get_frame_timestamp(...) on a device will return stable values 
                # until wait_for_frames(...) is called
                ...
                if out_queue.qsize() > 20:
                    try:
                        CMDS = out_queue.get()
                    except out_queue.Empty:
                        pass
